...
from django_fmd_ynh.cli_dev import app
...
def install():
    """
    Install requirements and 'django_fmd_ynh' via pip as editable.
    """
...
def publish():
    ...
    publish_package(module=django_fmd_ynh, package_path=get_project_root())
